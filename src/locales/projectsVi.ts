  ...
  reuse: {
    ...
    exhibits: {
      strategy: {
        ...
        desc: 'Từ bài toán đồ cũ lãng phí + lừa đảo trên MXH, mình xây rào chắn bằng xác thực email .edu.vn — biến ReuseUni thành "chợ tốt an toàn cho campus".',
        alt: "Khung chiến lược Lean Canvas",
      },
      mvp: {
        tag: "Exhibit 02 • Scope & Trade-offs",
        title: "Bức Tranh 02 — Định Nghĩa MVP & Quyết Định Trade-off",
        desc: "Mình cắt giảm 60% tính năng phụ qua ma trận Impact/Effort; giữ đúng 5 tính năng cốt lõi — launch MVP trong 2 tháng.",
      ...
      ux: {
        ...
        desc: "Thiết kế 5 luồng logic, phủ toàn bộ edge case — hơn 90% sinh viên thao tác trơn tru ngay lần đầu.",
        alt: "Sơ đồ User Flow",
      },
      prototype: {
        tag: "Exhibit 04 • Hi-Fi Prototype & System",
        title: "Bức Tranh 04 — Hệ Thống Design System & Prototype Tương Tác",
        desc: "Tự xây design system Mobile-First — rút hành trình đăng bài thanh lý còn 3 bước, điểm UX 4.0/5.0.",
      ...
      scrum: {
        ...
        desc: "Tự điều phối 4 Sprint qua GitHub Projects — bàn giao 100% deliverables đúng cam kết.",
      ...
      qa: {
        ...
        desc: "Dựng hàng rào kiểm thử tự động — 306/308 test pass, 82.5% coverage.",
